...
if __name__ == "__main__":
    ...
    classifier=models.Classifier(net=net,n_classes=[2,2,2])#,n_classes=[2,2,2])
    classifier=classifier.to(device)
    #classifier.load_state_dict(torch.load("./data/images_1/2x2_final2/classifier_combined.pth"))
    classifier.load_state_dict(torch.load("./data/images_1/2x2x2_final/classifier_combined.pth"))
    classifier=classifier.eval()

    fol=config["experiment_directory"]

    plot_data_path=os.path.join(fol,"plot_data.pth")
